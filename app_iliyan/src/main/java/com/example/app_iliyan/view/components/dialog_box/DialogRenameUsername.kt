...
fun DialogRenameUsername(
  ...
  var username = remember { mutableStateOf(LocalData.getAuthenticatedUser()?.username ?: "") }
  val initialUsername = LocalData.getAuthenticatedUser()?.username ?: ""

  var isConfirmBtnDisabled = username.value.isEmpty() || username.value == initialUsername
